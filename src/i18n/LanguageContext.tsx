...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    'sidebar.mentorship.desc': 'Assignments',
    ...
    'announcements.emptyFiltered': 'No announcements.',
  ...
  bg: {
    ...
    'sidebar.mentorship.desc': 'Разпределения',
    ...
    'announcements.new': 'Ново съобщение',
    'announcements.loading': 'Зареждане на съобщения...',
    'announcements.empty': 'Все още няма съобщения.',
    'announcements.emptyFiltered': 'Няма съобщения.',
